...
#ifndef INCLUDE_RINVID_CORE_TRANSFORMABLE_H
#define INCLUDE_RINVID_CORE_TRANSFORMABLE_H
...
class Transformable
{
  public:
     ...
     *
     * @param degree_angle angle in degrees to be added to objects current angle
     *
     *************************************************************************************************/
...
#endif // INCLUDE_RINVID_CORE_TRANSFORMABLE_H
